...
<article className="card"><span className='car-img'><img src='images\4401280.jpg' width="100%" height="100%" /></span> <h4>Mathematics</h4>

</article>

<article className="card"><span className='car-img'><img src='images\4412009.jpg' width="100%" height="100%" /></span> <h4>Problem - Solving skills</h4>
