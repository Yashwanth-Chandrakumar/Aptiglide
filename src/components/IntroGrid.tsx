...
<article className="card intro"><span className='car-img'><img src='./images/8084.jpg' width="100%" height="100%" /></span> <h4>C++</h4>

</article>

<article className="card intro"><span className='car-img'><img src='./images/4412009.jpg' width="100%" height="100%" /></span> <h4>JS</h4>
