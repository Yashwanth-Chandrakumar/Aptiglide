...
<div className="conteudo2"> <div className="carrousel1">

<article className="card">
<span className='car-img'><img src='images\20943758.jpg' width="100%" height="100%" /></span>
<h4>Java</h4>

</article>

<article className="card"><span className='car-img'><img src='images\4401280.jpg' width="100%" height="100%" /></span> <h4>Python</h4>

</article>

<article className="card"><span className='car-img'><img src='images\4412009.jpg' width="100%" height="100%" /></span> <h4>DBMS</h4>

</article> 
<article className="card">
<span className='car-img'><img src='images\6203326.jpg' width="100%" height="100%" /></span>
<h4>Mathematics-I</h4> </article>
